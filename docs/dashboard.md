...
(agents, runtimes, auth, delegation, maintenance, backup, health, events), plus
`--json` output and per-section scoping. The mutating actions the old dashboard offered
