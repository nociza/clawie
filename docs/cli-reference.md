...
sudo clawie channel telegram setup AGENT_ID [--token-file PATH | --token-stdin] [--wait-seconds N] [--replace] [--json]
...
and exits nonzero when unhealthy; pairing remains the secure default. Setup
